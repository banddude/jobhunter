...
DEFAULT_MIN_SCORE = int(config.DEFAULTS["min_score"])
APPLY_TIMEOUT_SECONDS = int(config.DEFAULTS["apply_timeout"])
...
def acquire_job(target_url: str | None = None, min_score: int = DEFAULT_MIN_SCORE,
...
def gen_prompt(target_url: str, min_score: int = DEFAULT_MIN_SCORE,
...
def worker_loop(worker_id: int = 0, limit: int = 1,
                ...
                min_score: int = DEFAULT_MIN_SCORE, headless: bool = False,
...
def main(limit: int = 1, target_url: str | None = None,
         min_score: int = DEFAULT_MIN_SCORE, headless: bool = False, model: str = "sonnet",
         dry_run: bool = False, continuous: bool = False,
         poll_interval: int = int(config.DEFAULTS["poll_interval"]), workers: int = 1) -> None:
