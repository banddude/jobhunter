...
from applypilot.config import COVER_LETTER_DIR, DEFAULTS, RESUME_PATH, load_profile
...
MAX_ATTEMPTS = int(DEFAULTS["max_tailor_attempts"])
DEFAULT_RETRIES = min(3, MAX_ATTEMPTS)
...
def generate_cover_letter(
    resume_text: str, job: dict, profile: dict, max_retries: int = DEFAULT_RETRIES
) -> str:
...
def run_cover_letters(min_score: int = DEFAULT_MIN_SCORE, limit: int = 20) -> dict:
