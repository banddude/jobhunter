...
| Gemini CLI | Scoring, tailoring, cover letters | Install from [github.com/google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) |
| Chrome/Chromium | Auto-apply | Auto-detected on most systems |
| Claude Code CLI | Auto-apply | Install from [claude.ai/code](https://claude.ai/code) |

**Gemini CLI is required** for all LLM features.
...
### `.env`
Runtime config, `CAPSOLVER_API_KEY` (optional).
